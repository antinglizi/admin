...
<form class="form-horizontal">
    <div class="form-group">
        <label for="user_phone" class="col-lg-4 control-label"><span class="required">*</span>新的手机号</label>
        <div class="col-lg-5">
            <input type="text" name="user_phone" id="user_phone" class="form-control" placeholder="新的手机号" required>
        </div>
    </div>
    <div class="form-group">
    ...
    <div>
        <button type="button" id="change_phone" class="btn btn-success center-block bg-green w150">修 改</button>
    </div>
</form>