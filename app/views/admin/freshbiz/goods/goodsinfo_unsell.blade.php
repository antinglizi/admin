...
@section('title') @parent 已下架菜品  @stop
...
<div id="content-right">
		        	...
		        	<div class="panel panel-default">
	                    ...
	                    <div>
	                    	<table id="goods_list_table" class="table table-bordered">
			                	...
			                	<tbody data-shopid="{{ $headerShop->wy_shop_id }}" data-goodsid="{{ $good->wy_goods_id }}" data-goodsname="{{ $good->wy_goods_name }}" data-goodsstatus="1">
			                		<tr class="text-center">
										...
										<td>
											<div>
					        					<a class="btn btn-success btn-xs bg-green" href="{{ route('goods.list.unsell.info', array("goodsID" => $good->wy_goods_id, "shopID" => $headerShop->wy_shop_id)) }}">
												<span class="fa fa-search-plus"><span class="pl-5">菜品信息</span></span></a>
					        				</div>
					        				<div class="mt-15">
												<button class="btn btn-warning btn-xs" data-toggle="modal" data-target="#goods_changestatus_modal"><span class="fa fa-arrow-circle-o-down"><span class="pl-5">菜品上架</span></span></button>
											</div>
											<div class="mt-15">
    ...
    @include ('admin.freshbiz.goods.goodschangestatus', array('modalTitle' => '菜品上架', 'modalBody' => '上架'))
